...
- stable tags must follow `iris-vX.Y.Z` (for example `iris-v0.1.3`)
...
- for first-time secure release setup, derive and set `SIGNING_PUBLIC_KEY_BASE64_DER` from your private key before tagging
